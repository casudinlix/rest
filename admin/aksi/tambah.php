...
<td><input type="text" name="kode" value=<?php echo $kode;?> disabled></td>
</tr>
...
<td><input type="date" name="tgl" value="<?php echo $tglsekarang; ?>" disabled></td>
</tr>
<tr><td colspan="" rowspan="" headers="">Gambar</td>
<td><input type="file" name="gambar"></td>
</tr>
<tr><td colspan="" rowspan="" headers="">Terjual</td>
<td><input type="teks" name="terjual" value="0" disabled=""></td>
</tr>
