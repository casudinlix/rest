...
<?php
$kode =$_GET['id'];
$sql=$conn->query("SELECT * FROM produk WHERE id_produk='$kode'");
$row = $sql->fetch_array();
?>
...
<td><input type="text" name="harga" value="<?php echo $row['harga_jual']; ?>"></td>
</tr>
...
<td><input type="teks" name="terjual" value="<?php echo $row['terjual']; ?>"></td>
</tr>
